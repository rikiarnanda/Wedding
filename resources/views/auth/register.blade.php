...
<div class="w-full max-w-md bg-white p-10 rounded-md shadow-lg flex flex-col justify-center items-center mx-auto">
    ...
    <form method="POST" action="{{ route('daftar') }}" class="w-full max-w-md">
        @csrf
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <textarea id="alamat" name="alamat" class="bg-gray-50 border border-gray-500 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" required></textarea>
        </div>
        <div class="mb-3">
            <label for="no_hp" class="block mb-2 text-sm font-medium text-gray-900">No Yang Bisa Dihubungi</label>
            <input id="no_hp" type="text" name="no_hp" class="bg-gray-50 border border-gray-500 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" required>
        </div>
        <div class="mb-3">
