...
<div class="w-full bg-gray-50 min-h-screen md:pl-52 md:pr-12 py-32 px-4">
    <h1 class="text-xl font-bold mb-4 text-gray-600">Daftar Vendor</h1>
        ...
        <table id="my-datatable" class="display bg-gray-100 text-sm w-full p-10 rounded-lg mt-10 shadow-md">
            <thead class="bg-gray-300">
                <tr>
                    ...
                    <th class="whitespace-nowrap px-3 py-2 font-medium text-gray-900">Nama Vendor</th>
                    <th class="whitespace-nowrap px-3 py-2 font-medium text-gray-900">Gambar</th>
                    <th class="whitespace-nowrap px-3 py-2 font-medium text-gray-900">Lokasi</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="whitespace-nowrap px-3 py-3 gap-3 border-b border-gray-400">
                        <a href="{{ route('vendor.edit', ['id' => $ven->id]) }}" class="inline-block rounded bg-amber-400 px-4 py-2 text-xs font-medium text-white hover:bg-amber-300 transition-all">Edit</a>
                        <form action="{{ route('vendor.delete', ['id' => $ven->id]) }}" method="POST" style="display:inline;">
                            @csrf
                            @method('DELETE')
