...
<div class="container mx-auto py-8">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 mx-auto overflow-hidden gap-8">
        ...
        <div class="border rounded-lg p-4 text-center bg-white shadow-lg hover:shadow-xl transition-shadow duration-300">
            <div class="h-48 overflow-hidden rounded-lg mb-4">
                <img src="{{ asset($crew->link_gbr) }}" alt="{{ $crew->nama }}" class="w-full h-full object-cover object-top">
            </div>
