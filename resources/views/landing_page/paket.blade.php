...
<div class="container mx-auto py-8">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        <div class="border rounded-lg p-4 bg-white shadow-lg hover:shadow-xl transition-shadow duration-300">
            ...
            <p class="text-lime-500 text-lg font-semibold mt-4">Rp. {{ number_format($paket->harga, 0, ',', '.') }}</p>
            <button class="items-center mt-2 bg-amber-500 text-white px-4 py-2 rounded hover:bg-amber-600 transition-colors duration-300">Booking Sekarang</button>
        </div>
        @endforeach
    </div>
</div>
