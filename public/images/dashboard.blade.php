...
@section('content')
<!-- Section: Hero -->
<section x-data="{ show: false }" x-intersect="show = true" x-transition:enter="transition ease-out duration-500"
    x-transition:enter-start="opacity-0 translate-y-4" x-transition:enter-end="opacity-100 translate-y-0"
    x-transition:leave="transition ease-in duration-300" x-transition:leave-start="opacity-100 translate-y-0"
    x-transition:leave-end="opacity-0 translate-y-4" class="min-h-screen flex items-center bg-white">
    <div class="container mx-auto flex flex-col-reverse md:flex-row items-center px-4 py-12">
        <div class="w-full md:w-1/2 text-center md:text-left">
            ...
            <p class="text-gray-600 my-4">Beli cincin di pasar lama Cincin cantik untuk si dia, Kenalin ini KIKI Jamin
                buat acara wedding jadi ceria.</p>
            <button
                class="bg-yellow-500 text-white px-6 py-3 rounded shadow-md hover:bg-yellow-600 transition-colors duration-300">Hubungi
                Kami</button>
        </div>
        <div class="w-full md:w-1/2">
            <img src="{{ asset('images/hero.jpg') }}" alt="Wedding Organizer"
...
<section x-data="{ show: false }" x-intersect="show = true" x-transition:enter="transition ease-out duration-500"
    x-transition:enter-start="opacity-0 translate-y-4" x-transition:enter-end="opacity-100 translate-y-0"
    x-transition:leave="transition ease-in duration-300" x-transition:leave-start="opacity-100 translate-y-0"
    x-transition:leave-end="opacity-0 translate-y-4" class="min-h-screen flex items-center py-12 bg-gray-100">
...
<section x-data="{ show: false }" x-intersect="show = true" x-transition:enter="transition ease-out duration-500"
    ...
    class="min-h-screen flex items-center py-12 bg-gradient-to-r from-yellow-500 to-yellow-300">
    <div class="container mx-auto px-4 text-center">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div
                class="bg-white bg-opacity-70 rounded-lg shadow-lg p-6 transform hover:scale-105 transition-transform duration-300">
                <div class="flex justify-center mb-4">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24px" height="24px">
                        <path
                            d="M 11.984375 -0.013671875 A 1.0001 1.0001 0 0 0 11 1 L 11 2 A 1.0001 1.0001 0 1 0 13 2 L 13 1 A 1.0001 1.0001 0 0 0 11.984375 -0.013671875 z M 4.2109375 3.2109375 A 1.0001 1.0001 0 0 0 3.515625 4.9296875 L 4.2226562 5.6367188 A 1.0001 1.0001 0 1 0 5.6367188 4.2226562 L 4.9296875 3.515625 A 1.0001 1.0001 0 0 0 4.2109375 3.2109375 z M 19.757812 3.2128906 A 1.0001 1.0001 0 0 0 19.070312 3.515625 L 18.363281 4.2226562 A 1.0001 1.0001 0 1 0 19.777344 5.6367188 L 20.484375 4.9296875 A 1.0001 1.0001 0 0 0 19.757812 3.2128906 z M 12 5 C 8.14 5 5 8.14 5 12 C 5 14.785 6.639 17.188453 9 18.314453 L 9 21 C 9 22.103 9.897 23 11 23 L 13 23 C 14.103 23 15 22.103 15 21 L 15 18.314453 C 17.361 17.188453 19 14.785 19 12 C 19 8.14 15.86 5 12 5 z M 1 11 A 1.0001 1.0001 0 1 0 1 13 L 2 13 A 1.0001 1.0001 0 1 0 2 11 L 1 11 z M 22 11 A 1.0001 1.0001 0 1 0 22 13 L 23 13 A 1.0001 1.0001 0 1 0 23 11 L 22 11 z M 4.9101562 18.060547 A 1.0001 1.0001 0 0 0 4.2226562 18.363281 L 3.515625 19.070312 A 1.0001 1.0001 0 1 0 4.9296875 20.484375 L 5.6367188 19.777344 A 1.0001 1.0001 0 0 0 4.9101562 18.060547 z M 19.060547 18.060547 A 1.0001 1.0001 0 0 0 18.363281 19.777344 L 19.070312 20.484375 A 1.0001 1.0001 0 1 0 20.484375 19.070312 L 19.777344 18.363281 A 1.0001 1.0001 0 0 0 19.060547 18.060547 z" />
                    </svg>
                </div>
...
<section x-data="{ show: false }" x-intersect="show = true" x-transition:enter="transition ease-out duration-500"
    ...
    <div class="container mx-auto px-4 text-center">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div
                class="bg-white bg-opacity-70 rounded-lg shadow-lg p-6 transform hover:scale-105 transition-transform duration-300 text-center">
                ...
                <button
                    class="mt-4 bg-yellow-500 text-white px-4 py-2 rounded hover:bg-yellow-600 transition-colors duration-300">Booking
                    Sekarang</button>
            </div>
            @endforeach
        </div>
...
<section x-data="{ show: false }" x-intersect="show = true" x-transition:enter="transition ease-out duration-500"
    ...
    x-transition:leave="transition ease-in duration-300" x-transition:leave-start="opacity-100 translate-y-0"
    x-transition:leave-end="opacity-0 translate-y-4"
    class="min-h-screen flex items-center py-12 relative bg-cover bg-center">
    <!-- Overlay -->
